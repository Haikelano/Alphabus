...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // list_affectations
        if ('/listaffectations' === $pathinfo) {
            return array (  '_controller' => 'My\\AlphabusBundle\\Controller\\AfficheAffectationController::listaffectationsAction',  '_route' => 'list_affectations',);
        }

        // cherche_affectation
        if ('/chercheaffectation' === $pathinfo) {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                goto not_cherche_affectation;
            }

            return array (  '_controller' => 'My\\AlphabusBundle\\Controller\\AfficheAffectationController::cherchassisAction',  '_route' => 'cherche_affectation',);
        }
        not_cherche_affectation:
