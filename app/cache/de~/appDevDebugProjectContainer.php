...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'alphabus', 'user' => 'root', 'password' => 'Database', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/My/AlphabusBundle/Entity'), 1 => ($this->targetDirs[3].'/src/My/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/src/My/ControlerBundle/Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'My\\AlphabusBundle\\Entity');
        $d->addDriver($c, 'My\\UserBundle\\Entity');
        $d->addDriver($c, 'My\\ControlerBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'MyAlphabusBundle' => 'My\\AlphabusBundle\\Entity', 'MyUserBundle' => 'My\\UserBundle\\Entity', 'MyControlerBundle' => 'My\\ControlerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_6410f9c6b4121cc7bba3d51d0102b464c892b1e2e4f042678c1d6a0e5ba8f628');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/My/ControlerBundle/Resources/views'), 'MyControler');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyControlerBundle' => 'My\\ControlerBundle\\MyControlerBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'MyControlerBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/My/ControlerBundle'),
