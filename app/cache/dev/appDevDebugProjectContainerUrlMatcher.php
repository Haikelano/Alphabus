...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        // my_user_default_index
        if ('' === rtrim($pathinfo, '/')) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($rawPathinfo.'/', 'my_user_default_index');
            }

            return array (  '_controller' => 'My\\UserBundle\\Controller\\DefaultController::indexAction',  '_route' => 'my_user_default_index',);
        }
